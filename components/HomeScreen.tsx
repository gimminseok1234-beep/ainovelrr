...
import { BookOpen, Edit3, Plus, Trash2, Settings, FileText, PenTool, MessageSquare, Zap, FolderOpen, FileSearch, RefreshCcw, X, Sliders, Info, CheckCircle, AlertTriangle, Sparkles, Save, Download, Upload, Check, Wand2, CheckCircle2, Flame, Library, LayoutTemplate, ListPlus, Edit2, Bot } from 'lucide-react';
import { Project, SavedStory, ViewMode, NovelSettings, EditorPreferences, DEFAULT_SETTINGS, AiPreset } from '../types.ts';
...
const HomeScreen: React.FC<HomeScreenProps> = ({ 
  ...
  const handleSettingChange = (field: keyof NovelSettings, value: any) => {
      if (onUpdateSettings && settings) {
